  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Message" do
        ...
        #creates message and increase the count of messages by 1, to signify that it has been created
      end

      it "redirects to the created message" do
        post :create, params: {message: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Message.last)
        #expect the response to redirect to the last message created
      end
    end
#if it is with invalid params do
